...
Vagrant.configure(VAGRANT_API_VERSION) do |config|
  ...
  config.vm.define "lb" do |lb|
    ...
    lb.vm.network "forwarded_port", guest: 22, host: 2222
  end
  ...
  (1..2).each do |i|
    config.vm.define "web#{i}" do |web|
      ...
      web.vm.network "forwarded_port", guest: 80, host: 8082 + i  # web1 => 8083, web2 => 8084
      web.vm.network "forwarded_port", guest: 22, host: 2222 + i   # SSH ports: 2223, 2224
    end
  end
